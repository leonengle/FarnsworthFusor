...
The repository is divided into a directory containing Python code for a Supervisory Control and Data Acquisition (SCADA) and a directory documenting the progress of the power supply. See the power supply directory for what I (Leon) am currently working on. 
