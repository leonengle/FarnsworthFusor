...
## Overview
Here a design (in progress) is presented for a 400W 120VrmsAC 60Hz -> -33kVDC Power Converter; to power a Farnsworth Fusor. The power converter has four stages: a rectifier, an inverter, a ferrite UU core 1:30 transformer, and an 8x voltage multiplier. 
